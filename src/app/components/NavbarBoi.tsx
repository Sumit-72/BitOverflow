        ...
        <div className="relative w-full px-6 py-4 bg-white dark:bg-gray-900">
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-2">
                    ...
                    />
                    <div className="text-xl font-bold text-gray-800 dark:text-white">BitOverflow</div>
                </div>
                ...
                <div className="flex space-x-4">
                    ...
                    {session ? (
                        <button
                            ...
                            className="flex items-center space-x-2 px-3 py-1 bg-gray-100 dark:bg-gray-800 rounded-md shadow-md hover:bg-gray-200 dark:hover:bg-gray-700 transition duration-200"
                        >
                            <span className="text-sm font-medium text-gray-700 dark:text-white">Logout</span>
                        </button>
                    ) : (
                        <>
                            <Link
                                ...
                                className="flex items-center space-x-2 px-3 py-1 bg-gray-100 dark:bg-gray-800 rounded-md shadow-md hover:bg-gray-200 dark:hover:bg-gray-700 transition duration-200"
                            >
                                <span className="text-sm font-medium text-gray-700 dark:text-white">Login</span>
                            </Link>
                            <Link
                                href="/register"
                                className="flex items-center space-x-2 px-3 py-1 bg-gray-100 dark:bg-gray-800 rounded-md shadow-md hover:bg-gray-200 dark:hover:bg-gray-700 transition duration-200"
                            >
                                <span className="text-sm font-medium text-gray-700 dark:text-white">Signup</span>
                            </Link>
                        </>
                    )}
                </div>
