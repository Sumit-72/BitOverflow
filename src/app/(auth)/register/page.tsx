...
export default function Register() {
    const { login, createAccount, loginWithOAuth } = useAuthStore(); // <-- add loginWithOAuth
            ...
            <form className="my-8" onSubmit={handleSubmit}>
                ...
                <div className="flex flex-col space-y-4">
                    <button
                        ...
                        type="button"
                        disabled={isLoading}
                        onClick={() => loginWithOAuth("google")} // <-- Google OAuth
                    >
                    ...
                    <button
                        ...
                        type="button"
                        disabled={isLoading}
                        onClick={() => loginWithOAuth("github")} // <-- GitHub OAuth
                    >
